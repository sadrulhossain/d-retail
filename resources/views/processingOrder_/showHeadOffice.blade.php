...
<div class="form-group">
    ...
    <div class="col-md-8">
        {{ Form::textarea('address', $courierInfo->address, ['id'=> 'address', 'class' => 'form-control','size' => '30x2','autocomplete' => 'off', 'readonly']) }}
...
<div class="form-group">
    ...
    <div class="col-md-8">
        {!! Form::text('branch_contact_no',$courierInfo->number, ['id'=> 'branchContactNo', 'class' => 'form-control', 'readonly']) !!} 
...
<div class="form-group">
    ...
    <div class="col-md-8">
        {!! Form::text('email',$courierInfo->email, ['id'=> 'email', 'class' => 'form-control', 'readonly']) !!} 
