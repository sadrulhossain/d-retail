...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-bar-chart"></i>@lang('label.BRAND_WISE_SALES_SUMMARY_REPORT')
            </div>
            <div class="actions">
                <span class="text-right">
                    @if(Request::get('generate') == 'true')
                    @if(!empty($userAccessArr[55][6]) && @if(!empty($brandList)))
        ...
        <div class="portlet-body">
            {!! Form::open(array('group' => 'form', 'url' => 'brandWiseSalesSummaryReport/filter','class' => 'form-horizontal')) !!}
            <div class="row">
                <div class="col-md-4">
...
if (!empty($brandList)) {
    foreach ($brandList as $brandId => $brandName) {
        $volume = $salesSummaryArr[$brandId]['volume'] ?? 0;
        echo "'$volume',";
    }
}
?>
...
if (!empty($brandList)) {
    foreach ($brandList as $brandId => $brandName) {
        $netIncome = $salesSummaryArr[$brandId]['net_income'] ?? 0;
        echo "'$netIncome',";
    }
}
?>
