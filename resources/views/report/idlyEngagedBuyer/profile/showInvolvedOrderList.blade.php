<div class="modal-content">
    <div class="modal-header clone-modal-header">
        ...
        <a class="btn green-haze pull-right tooltips vcenter margin-left-right-5" target="_blank" href="{{ URL::to('idlyEngagedBuyerReport/printInvolvedOrderList?buyer_id='.$request->buyer_id.'&sales_person_id='.$request->sales_person_id.'&type_id='.$request->type_id) }}"  title="@lang('label.CLICK_HERE_TO_PRINT')">
                    ...
                    <table class="table table-bordered table-hover  table-head-fixer-color">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @endif
                                <td class="vcenter" rowspan="{!! $inquryRowSpanArr[$inquiry->id] !!}">{!! $inquiry->supplier ?? '' !!}</td>
