...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-cart-plus"></i>@lang('label.STATUS_WISE_ORDER_LIST_REPORT')
            </div>
            <div class="actions">
        ...
        <div class="portlet-body">
            <!-- Begin Filter-->
            {!! Form::open(array('group' => 'form', 'url' => 'admin/statusWiseOrderListReport/filter','class' => 'form-horizontal')) !!}
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {!! Form::select('status', $statusList, Request::get('status'), ['class' => 'form-control js-source-states','id'=>'statusId']) !!}
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-right vcenter">
                                        ${{!empty($salesSummuryArr['pending']['amount']) ? Helper::numberFormat2Digit($salesSummuryArr['pending']['amount']) : '0.00'}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-center vcenter">
                                    ...
                                    <td class="text-right vcenter">
                                        ${{!empty($salesSummuryArr['delivered']['amount']) ? Helper::numberFormat2Digit($salesSummuryArr['delivered']['amount']) : '0.00'}}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="text-center vcenter">
                                    ...
                                    <td class="text-right vcenter">
                                        {{!empty($salesSummuryArr['cancel']['volume']) ? $salesSummuryArr['cancel']['volume'] : '0'}}  @lang('label.UNIT')
                                    </td>
                                    <td class="text-right vcenter">
                                        ${{!empty($salesSummuryArr['cancel']['amount']) ? Helper::numberFormat2Digit($salesSummuryArr['cancel']['amount']) : '0.00'}}
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-right vcenter bold">
                                        ${{!empty($salesSummuryArr['delivered']['totalAmount']) ? $salesSummuryArr['delivered']['totalAmount'] : 0}}
