...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-cubes"></i>@lang('label.ZONAL_PERFORMANCE_REPORT')
            </div>
            <div class="actions">
        ...
        <div class="portlet-body">
            <!-- Begin Filter-->
            {!! Form::open(array('group' => 'form', 'url' => 'admin/zonalPerformanceReport/filter','class' => 'form-horizontal')) !!}
            <div class="row">
                <div class="col-md-4">
            ...
            <div class="row margin-top-5">
                <div class="col-md-4 chart-view">
                    ...
                    <div id="zonePerformancePiChart" style="width: 100%; height: 400px; margin: 0 auto;"></div>
                </div>
                <div class="col-md-8 chart-view">
                    <div id="zonePerformanceChart" style="width: 100%; height: 400px; margin: 0 auto;"></div>
                </div>
                        ...
                        <table class="table table-bordered table-hover table-head-fixer-color" id="fixTable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="vcenter" rowspan="2">@lang('label.ZONE')</th>
...
?>
        ...
        var zoneNoOfOrderStatus = new ApexCharts(document.querySelector("#zonePerformancePiChart"), zoneNoOfOrderOptions);
        zoneNoOfOrderStatus.render();
//**************************End:: cluster pi chart ****************************************


//*******************************Start ::  cluster performance ***************************************
        var zonePerformanceOptions = {
...
?>
            ...
            title: {
                text: "@lang('label.ZONAL_PERFORMANCE')",
                align: 'left',
                margin: 10,
                offsetX: 0,
                offsetY: 0,
        ...
        var zonePerformanceStatus = new ApexCharts(
                document.querySelector("#zonePerformanceChart"), zonePerformanceOptions
                );
        zonePerformanceStatus.render();
