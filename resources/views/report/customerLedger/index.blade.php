...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-cubes"></i>@lang('label.CUSTOMER_LEDGER_REPORT')
            </div>
            <div class="actions">
        ...
        <div class="portlet-body">
            <!-- Begin Filter-->
            {!! Form::open(array('group' => 'form', 'url' => 'admin/customerLedgerReport/filter','class' => 'form-horizontal')) !!}
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label class="control-label col-md-4" for="customerId">@lang('label.CUSTOMER') <span class="text-danger"> *</span></label>
                        <div class="col-md-8">
                            {!! Form::select('customer_id', $customerList, Request::get('customer_id'), ['class' => 'form-control js-source-states', 'id' => 'customerId']) !!}
                ...
                <div class="col-md-12">
                    <div class="bg-blue-hoki bg-font-blue-hoki">
                        <h5 style="padding: 10px;">
                            {{__('label.CUSTOMER')}} : <strong>{{  !empty($customerList[Request::get('customer_id')]) && Request::get('customer_id') != 0 ? $customerList[Request::get('customer_id')] : __('label.N_A') }} |</strong> 
