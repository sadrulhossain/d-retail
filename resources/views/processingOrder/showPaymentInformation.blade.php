                    ...
                    <div class="col-md-12">
                        <table class="table table-bordered table-hover" id="dataTable">
                            ...
                            <tbody>
                                ...
                                <?php
                                $freezeStockArr = Common::getFreezeStock($target['warehouse_id'], $orderDetailInfo['order_id']);
                                ?>
                                <tr>
                                    ...
                                    <td class="text-center vcenter width-80">{{ (int)$target['available_quantity'] }}</td>
