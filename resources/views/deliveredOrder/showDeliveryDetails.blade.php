...
<div class="modal-content">
    <div class="modal-header clone-modal-header">
        ...
        <a class="btn green-haze pull-right tooltips vcenter margin-left-right-5" target="_blank" href="{{ URL::to('admin/deliveredOrder/' . $request->delivery_id . '/printInvoice') }}" title="" data-original-title="Click here to Print">
