            ...
            <div class="row margin-bottom-10">
                <div class="col-md-12">
                    <div class="text-center bold uppercase">
                        <span class="header">@lang('label.INVOICE')</span>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <table class="table no-border">
                        <tr class="no-border">
                            ...
                            <td class="no-border v-top" width="30%">
                                <span class="bold">@lang('label.INVOICE_NUMBER'): </span>{!! $order->invoice_no ?? '' !!}<br/>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="vcenter text-right bold">
                                        <span class="net-payable">{!! !empty($order->grand_total) ? Helper::numberFormat2Digit($order->net_receivable) : '0.00' !!}</span>&nbsp;@lang('label.TK')
                                    </td>
                                    {!! Form::hidden('net_payable', $order->net_receivable, ['id' => 'netPayable']) !!}
                                </tr>
                                <tr>
                                    <td class="vcenter text-right bold">@lang('label.IN_WORDS')</td>
                                    <td class="vcenter bold" colspan="4">
                                        <span class="net-payable uppercase italic">{!! !empty($order->net_receivable) ? Helper::numberToWord($order->net_receivable) : Helper::numberToWord(0.00) !!}</span>&nbsp;@lang('label.TK')
                                    </td>
                                </tr>
                            </tbody>
