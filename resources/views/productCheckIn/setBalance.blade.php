                ...
                <div class="row">
                    ...
                    <div class="form">
                        <div class="col-md-2">
                            ...
                            <div class="checkbox-center md-checkbox">
                                {!! Form::checkbox('m_label',1,false,['id' => 'mLabel', 'class'=> 'md-check']) !!}
                                <label for="mLabel">
                                    <span class="inc"></span>
                    ...
                    <div class="form">
                        <div class="col-md-2">
                            ...
                            <div class="checkbox-center md-checkbox">
                                {!! Form::checkbox('msds',1,false,['id' => 'msds', 'class'=> 'md-check']) !!}
                                <label for="msds">
                                    <span class="inc"></span>
                                    <span class="check mark-caheck"></span>
                                    <span class="box mark-caheck"></span>
                    ...
                    <div class="form">
                        <div class="col-md-2">
                            ...
                            <div class="checkbox-center md-checkbox">
                                {!! Form::checkbox('factory_label',1,false, ['id' => 'factoryLabel', 'class'=> 'md-check']) !!}
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $(document).on("change", '#productId', function() {
            ...
            $.ajax({
                url: "{{URL::to('admin/initialBalance/getSupplierManufacturer')}}",
                type: 'POST',
                dataType: 'json',
                headers: {
        ...
        $(document).on("change", '#manufacturerId', function() {
            ...
            $.ajax({
                url: "{{URL::to('admin/initialBalance/getManufacturerAddress')}}",
                type: 'POST',
                dataType: 'json',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $('#addItem').click(function() {
            ...
            $.ajax({
                url: "{{ URL::to('admin/initialBalance/purchaseNew')}}",
                type: "POST",
                dataType: 'json',
                cache: false,
                headers: {
...
//                $("#factoryLabel").prop("checked", false);
        ...
        $('#productId').on('change', function() {
            ...
            if (productId != '0') {
                $.ajax({
                    url: "{{URL::to('admin/initialBalance/productHints')}}",
                    type: "POST",
        ...
        $(document).on("click", ".button-submit", function(e) {
            ...
            swal({
                ...
                if (isConfirm)
                    ...
                    $.ajax({
                        url: "{{URL::to('admin/initialBalance/set/')}}",
                        type: "POST",
