...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.SPECIAL_PRODUCT_LIST')
            </div>
        </div>
...
?>
        ...
        $(document).on('click', '#buttonSubmit', function (e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: "{{URL::to('admin/specialProducts/saveProducts')}}",
                        type: "POST",
                        datatype: 'json',
                        cache: false,
                        contentType: false,
    ...
    $(document).on("click", "#selectedSKU", function (e) {
        e.preventDefault();
        $.ajax({
            url: "{{ URL::to('admin/specialProducts/getSelectedSKU')}}",
            type: "POST",
            dataType: "json",
            headers: {
