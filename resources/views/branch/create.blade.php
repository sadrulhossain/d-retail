...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-home"></i>@lang('label.CREATE_BRANCH')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::open(array('group' => 'form', 'url' => 'admin/branch', 'class' => 'form-horizontal', 'files' => true)) !!}
                ...
                <div class="row">
                    <div class="col-md-offset-1 col-md-7">
                        <div class="form-group">
                            <label class="control-label col-md-4" for="courierId">@lang('label.COURIER'):</label>
                            <div class="col-md-8">
                                {!! Form::select('courier_id',  $courierList, null, ['class' => 'form-control js-source-states','id'=>'courierId']) !!}
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::select('country_id', $countryArr, '18', ['class' => 'form-control js-source-states', 'id' => 'countryId']) !!}
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-4 col-md-8">
                        ...
                        <a href="{{ URL::to('/admin/branch'.Helper::queryPageStr($qpArr)) }}" class="btn btn-circle btn-outline grey-salsa">@lang('label.CANCEL')</a>
                    </div>
                </div>
            </div>
            {!! Form::close() !!}
...
<script type="text/javascript">
    $(function () {
        ...
        $(document).on('change', '#countryId', function () {
            ...
            $.ajax({
                url: '{{URL::to("admin/branch/getDivisionToCreate/")}}',
                type: 'POST',
                dataType: 'json',
                headers: {
        ...
        $(document).on('change', '#divisionId', function () {
            ...
            $.ajax({
                url: '{{URL::to("admin/branch/getDistrictToCreate/")}}',
                type: 'POST',
                dataType: 'json',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on('change', '#districtId', function () {
            ...
            $.ajax({
                url: '{{URL::to("admin/branch/getThanaToCreate/")}}',
                type: 'POST',
                dataType: 'json',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
