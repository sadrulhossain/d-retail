...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-th-list"></i>@lang('label.CANCELLED_ORDER_LIST')
            </div>
        </div>
        <div class="portlet-body">
            <!-- Begin Filter-->
            {!! Form::open(array('group' => 'form', 'url' => 'admin/cancelledOrder/filter','class' => 'form-horizontal')) !!}
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        @else
                        <tr>
                            <td colspan="18" class="vcenter">@lang('label.NO_CANCELLED_ORDER_FOUND')</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
