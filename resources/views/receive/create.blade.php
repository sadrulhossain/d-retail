...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-user"></i>@lang('label.RECEIVE')
            </div>
        </div>
        <div class="portlet-body">
            {!! Form::open(array('group' => 'form', 'url' => '','class' => 'form-horizontal', 'id' => 'receiveForm')) !!}
            <div class="form-body">
                <div class="row">
                    <div class="col-md-12">
                        <!-- Begin Filter-->
                        <div class="col-md-offset-2 col-md-5">
                            <div class="form-group">
                                <label class="control-label col-md-4" for="retailerId">@lang('label.RETAILER') </label>
                                <div class="col-md-8">
...
<script type="text/javascript">
    $(function () {
        ...
        $(document).on("click", ".filter-submit", function (e) {
            ...
            $.ajax({
                url: "{{ URL::to('admin/receive/getReceiveData') }}",
                type: "POST",
        ...
        $(document).on("click", "#previewReceive", function (e) {
            ...
            $.ajax({
                url: "{{URL::to('admin/receive/previewReceiveData')}}",
                type: "POST",
                dataType: 'json', // what to expect back from the PHP script, if anything
                cache: false,
                contentType: false,
        ...
        $(document).on("click", "#setReceive", function (e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        url: "{{ URL::to('admin/receive/setReceiveData') }}",
                        type: "POST",
                        dataType: 'json', // what to expect back from the PHP script, if anything
                        cache: false,
                        contentType: false,
