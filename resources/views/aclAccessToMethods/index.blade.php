...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            ...
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('admin/aclAccessToMethods/addAccessMethod'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_ACCESS_TO_METHODS')
