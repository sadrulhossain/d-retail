...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-list"></i>@lang('label.EDIT_WAREHOUSE')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::model($target, ['route' => array('warehouse.update', $target->id), 'method' => 'PATCH','class' => 'form-horizontal'] ) !!}
                    ...
                    <div class="col-md-offset-1 col-md-7">
                        ...
                        <div class="form-group" id="cwh">
                            ...
                            <div class="col-md-8 checkbox-center md-checkbox has-success">
                                {!! Form::checkbox('allowed_for_central_warehouse',1,null, ['id'=> 'allowedForCwh', 'class' => 'allowed-for-cwh make-switch','data-on-text'=> "Yes",'data-off-text'=>"No"]) !!}
...
$(document).ready(function () {
    ...
    if($('input[name="allowed_for_central_warehouse"]:checked').length > 0){
        $('#hideForCentralWarehouse').hide();
    }
    
    //START:: Ajax for Allow User as CWH
