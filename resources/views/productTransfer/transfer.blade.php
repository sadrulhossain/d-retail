...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-list"></i>@lang('label.PRODUCT_TRANSFER')
            </div>
            <div class="actions">
        ...
        <div class="portlet-body form">
            ...
            <div class="form-body">
                <div class="row">
                    ...
                    <div class="form">
                        <div class="col-md-3">
                            <label class="control-label" for="transferFrom">@lang('label.TRANSFER_FROM'):<span class="text-danger"> *</span></label>
                            @if(in_array(Auth::user()->group_id, [1, 11]))

                            {!! Form::text('tr_warehouse','Central Warehouse',['id' => 'transferFrom','class' => 'form-control','readonly']) !!}
                            {!! Form::hidden('tr_warehouse_id', 0) !!}

                            @elseif(Auth::user()->group_id == 12)
                            {!! Form::text('tr_warehouse',$warehouse->wh ?? '',['id' => 'transferFrom','class' => 'form-control','readonly']) !!}
                            {!! Form::hidden('tr_warehouse_id', $warehouse->wh_id ?? 0) !!}
                            @endif
                    ...
                    <div class="form">
                        <div class="col-md-3">
                            <label class="control-label" for="warehouse">@lang('label.TRANSFER_TO'):<span class="text-danger"> *</span></label>
                    ...
                    <div class="col-md-3">
                        <div class="form">
                            ...
                            {!! Form::text('transfer_date_text',Helper::formatDate($transferDate) , ['id'=> 'transferDateText', 'class' => 'form-control', 'placeholder' => 'yyyy-mm-dd', 'readonly']) !!}
                            {!! Form::hidden('transfer_date',$transferDate , ['id'=> 'transferDate', 'class' => 'form-control', 'placeholder' => 'yyyy-mm-dd', 'readonly']) !!}
                        </div>
                    </div>
            ...
            <div class="form-body">
                <div class="row">
                    <div class="col-md-12">
                        <p><b><u>@lang('label.TRANSFERRED_PRODUCT_LIST'):</u></b></p>
...
//            console.log(avQuantity);
        ...
        $(document).on("change", '#sku', function () {
            ...
            $.ajax({
                url: "{{URL::to('admin/stockTransfer/getProductName')}}",
                type: 'POST',
                dataType: 'json',
                headers: {
...
//            }
            ...
            $.ajax({
                url: "{{ URL::to('admin/stockTransfer/purchaseNew')}}",
                type: "POST",
                dataType: 'json',
                cache: false,
                headers: {
    ...
    $(document).on("click", ".button-submit", function (e) {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    url: "{{URL::to('admin/stockTransfer/transferProduct')}}",
                    type: "POST",
...
<?php if (!empty($userAccessArr[46][1])) { ?>
                                window.location.replace('{{URL::to("admin/stockTransferList")}}');
<?php } else { ?>
                                window.location.replace('{{URL::to("admin/stockTransfer")}}');
<?php } ?>
