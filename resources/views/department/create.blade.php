...
<div class="col-md-12">
    <div class="portlet box green">
        ...
        <div class="portlet-body form">
            {!! Form::open(array('group' => 'form', 'url' => 'admin/department','class' => 'form-horizontal')) !!}
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-4 col-md-8">
                        ...
                        <a href="{{ URL::to('/admin/department'.Helper::queryPageStr($qpArr)) }}" class="btn btn-circle btn-outline grey-salsa">@lang('label.CANCEL')</a>
                    </div>
                </div>
            </div>
            {!! Form::close() !!}
