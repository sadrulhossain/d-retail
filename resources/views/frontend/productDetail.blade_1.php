        ...
        <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
            <div class="wrap-product-detail row">
                <div class="detail-media col-md-7">
                    <div class="show-main-pro-img col-md-12">
                        <img class="add-main-image" src="{{URL::to('/')}}/public/uploads/product/thumbImage/{{ !empty(current($productImageArr)) ? current($productImageArr) : 'demo.jpg'  }}" id="show-img" alt="">
                    </div>
...
<script src="{{asset('public/js/zoom-image.js')}}" type="text/javascript"></script>
