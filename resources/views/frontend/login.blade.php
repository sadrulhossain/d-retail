                ...
                <div class="wrap-login-item ">
                    <div class="login-form form-item form-stl">
                        ...
                        <fieldset class="wrap-title">
                            ...
                            <h3 class="form-title text-center">@lang('label.LOGIN_IN')</h3>										
                        </fieldset>
                        <fieldset class="wrap-input">
                            <label for="frm-reg-lname">@lang('label.USERNAME')<span class="required"> *</span></label>
                            {!! Form::text('username', null, ['id'=> 'username', 'class' => 'form-control','autocomplete' => 'off','placeholder' => '']) !!}
                        </fieldset>
                        <fieldset class="wrap-input">
                        ...
                        <fieldset class="wrap-input">
                            ...
                            <!--<a class="link-function left-position" href="{{ url('requestForgotPassword') }}" title="Forgotten password?">@lang('label.FORGOT_PASSWORD')</a> 
