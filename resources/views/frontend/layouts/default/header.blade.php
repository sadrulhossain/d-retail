...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('public/frontend/assets/css/flexslider.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('public/frontend/assets/css/owl.carousel.min.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('public/frontend/assets/css/chosen.min.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('public/frontend/assets/css/custom.css')}}">

        <link rel="stylesheet" type="text/css" href="{{asset('public/frontend/assets/css/color-01.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('public/frontend/assets/css/color-01.css')}}">

<!--        <script src="{{asset('public/frontend/assets/js/sweetalert2.min.js')}}"></script>-->
        ...
        <script src="{{asset('public/frontend/assets/js/jquery-1.12.4.minb8ff.js?ver=1.12.4')}}" type="text/javascript"></script>
        <script src="{{asset('public/frontend/assets/js/jquery-ui-1.12.4.minb8ff.js?ver=1.12.4')}}" type="text/javascript"></script>
