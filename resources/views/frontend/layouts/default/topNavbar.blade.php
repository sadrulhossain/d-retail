                            ...
                            if (!empty($user)) {
                                ...
                                <li class="dropdown dropdown-user">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-default frontend-dropdown">
                                        ...
                                        <li>
                                            <a href="{{in_array($user->group_id,[14,18,19]) ? url('admin/myProfile') : url('admin/myProfile') }}">
                                                <i class="icon-key"></i>@lang('label.MY_PROFILE')</a>
                                        </li>
                                        <li>
                                            <a href="{{in_array($user->group_id,[18,19]) ? url('admin/retailerDistributorOrder') : url('admin/retailerDistributorOrder') }}">
                                                <i class="icon-key"></i>@lang('label.MY_ORDER')</a>
                                        </li>
                                        <li class="divider"> </li>
                                        <li>
                                ...
                                <li class="menu-item" ><a class="text-transform-none" title="@lang('label.REGISTER')" href="{{url('/register')}}">@lang('label.REGISTER')</a></li>
                                <?php
                            }
                            ?>
                        </ul>
                ...
                <div class="mid-section main-info-area">
                    ...
                    <div class="wrap-search center-section">
                        <div class="wrap-search-form">
                            <form action="{{ url('/search/product') }}" id="form-search-top" name="form-search-top">
                                <input type="text" name="search" value="{{Request::get('search')}}" placeholder="Search here..." list="productSearch" autocomplete="false">
                                <datalist id="productSearch" class="proSearch">
                                    @if(!empty($frontProductSearchList))
                                    @foreach($frontProductSearchList as $name=>$name)
