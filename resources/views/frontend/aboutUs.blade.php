        ...
        <div class="our-staff">
            <div
                ...
                <div class="team-member equal-elem">
                    <div class="media">
                        <a href="#" title="LEONA">
                            <figure><img src="{{asset('public/frontend/assets/images/member-leona.jpg')}}" alt="LEONA"></figure>
                        </a>
                    </div>
                    <div class="info">
                ...
                <div class="team-member equal-elem">
                    <div class="media">
                        <a href="#" title="LUCIA">
                            <figure><img src="{{asset('public/frontend/assets/images/member-lucia.jpg')}}" alt="LUCIA"></figure>
                        </a>
                    </div>
                    <div class="info">
                ...
                <div class="team-member equal-elem">
                    <div class="media">
                        <a href="#" title="NANA">
                            <figure><img src="{{asset('public/frontend/assets/images/member-nana.jpg')}}" alt="NANA"></figure>
                        </a>
                    </div>
                    <div class="info">
                        <b class="name">NANA</b>
                ...
                <div class="team-member equal-elem">
                    <div class="media">
                        <a href="#" title="BRAUM">
                            <figure><img src="{{asset('public/frontend/assets/images/member-braum.jpg')}}" alt="BRAUM"></figure>
                        </a>
                    </div>
                    <div class="info">
