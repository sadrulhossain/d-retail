...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-balance-scale"></i>@lang('label.PRODUCT_TAG_LIST')
            </div>
            <div class="actions">
                @if(!empty($userAccessArr[9][2]))
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('admin/productTag/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_PRODUCT_TAG')
        ...
        <div class="portlet-body">
            <div class="row">
                <!-- Begin Filter-->
                {!! Form::open(array('group' => 'form', 'url' => 'admin/productTag/filter','class' => 'form-horizontal')) !!}
                <div class="row">
                    <div class="col-md-4">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="td-actions text-center vcenter">
                                <div class="width-inherit">
                                    ...
                                    <a class="btn btn-xs btn-primary tooltips" title="Edit" href="{{ URL::to('admin/productTag/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    @endif
                                    @if(!empty($userAccessArr[9][4]))
                                    {{ Form::open(array('url' => 'admin/productTag/' . $target->id.'/'.Helper::queryPageStr($qpArr), 'class' => 'delete-form-inline')) }}
                        ...
                        @else
                        <tr>
                            <td colspan="8">@lang('label.NO_PRODUCT_TAG_FOUND')</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
