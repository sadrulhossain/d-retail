@if(Request::get('view') == 'print' || Request::get('view') == 'pdf')
<html>
    <head>
        <title>Invoice - {{ $sales->id }}</title>

        @if(Request::get('view') == 'print')
        <link rel="stylesheet" href="{{asset('public/invoice/invoice_style.css')}}">
        <link rel="stylesheet" href="{{asset('public/admin/vendors/bootstrap/dist/css/bootstrap.min.css')}}">
        @elseif(Request::get('view') == 'pdf')
        <link href="{{ asset('public/invoice/invoice_style.css')}}" rel="stylesheet" type="text/css"/>
        <link rel="stylesheet" href="{{asset('public/admin/vendors/bootstrap/dist/css/bootstrap.min.css')}}">
        @endif
        ...
        <div class="content-wrapper">
            ...
            <div class="invoice-description">
                ...
                <div class="invoice-right-top float-right">
                    ...
                    <p>
                        Date: {{ date('d-m-Y',strtotime($sales->created_at)) }}
                    </p>
                </div>
                <div class="clearfix"></div>
            </div>
        ...
        <table>
            <tr>
                <td colspan="5" style="text-align:center;">
                   <img src="{{ base_path().'/public/invoice/logo/logo.png' }}" alt=""> 
                </td>
            </tr>
            <tr>
                <td colspan="3">
                    Invioce: {{ $sales->customer_name }}
                </td>
                <td colspan="2">
                    Date: {{ date('d-m-Y',strtotime($sales->created_at)) }}
                </td>
