                        ...
                        <table class="table table-bordered table-hover table-head-fixer-color">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="vcenter">{!! $ets['order_no'] ?? __('label.N_A') !!}</td>
                                    <td class="vcenter">{!! $ets['buyer_name'] ?? __('label.N_A') !!}</td>
                                    <td class="vcenter">{!! $ets['supplier_name'] ?? __('label.N_A') !!}</td>
                                    <td class="vcenter">{!! $ets['sales_person_name'] ?? __('label.N_A') !!}</td>
                                    <td class="vcenter">{!! $ets['bl_no'] ?? __('label.N_A') !!}</td>
                                    <td class="vcenter">{!! $ets['express_tracking_no'] ?? __('label.N_A') !!}</td>
                                </tr>
                                @endforeach
                                @else
                                <tr>
