            ...
            <div class="row margin-bottom-10">
                <div class="col-md-12">
                    <div class="text-center bold uppercase">
                        <span class="header">@lang('label.SALES_STATUS_REPORT')</span>
                    </div>
                </div>
            </div>
            <!--SUMMARY-->
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="vcenter text-right">@lang('label.$'){{$details['unit_price']}}&nbsp;</td>
                                ...
                                <td class="vcenter text-right">@lang('label.$'){{$details['total_price']}}&nbsp;</td>


                                @if($i == 0)
                                <td class="vcenter text-right" rowspan="{{!empty($order['products']) ? sizeof($order['products']) : 1}}">@lang('label.$'){{$order['grand_total']}}&nbsp;</td>
