                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="{{$invTextAlign}} vcenter font-size-11">{!! !empty($invoiceNoList[$invoideId]) ? $invoiceNoList[$invoideId] : '--'  !!}</td>
                                        <td class="{{$billTextAlign}} vcenter font-size-11">{!! !empty($amount['billed']) ? Helper::numberFormat2Digit($amount['billed']).' '.__('label.TK') : '--' !!} </td>
                                        <td class="{{$recievedTextAlign}} vcenter font-size-11">{!! !empty($amount['received']) ? Helper::numberFormat2Digit($amount['received']).' '.__('label.TK') : '--' !!}</td>
                                        <td class="text-right vcenter font-size-11">{!! !empty($balanceArr[$dateTime][$invoideId]) ? Helper::numberFormat2Digit($balanceArr[$dateTime][$invoideId]) : Helper::numberFormat2Digit(0) !!} &#2547;</td>
                                    </tr>
                                    @endforeach
                                    @endforeach
                                    <tr>
