<div class="modal-content">
    ...
    {!! Form::hidden('warehouse_id', $order->warehouse_id, ['id' => 'warehouseId']) !!}
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-md-4">
                <span class="bold">@lang('label.RETAILER'): </span>{!! $order->retailer_name !!}
            </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            {!! Form::hidden('product_sku['.$orders->sku_id.'][delivery_details_id]', $orders->delivery_details_id, ['id' => 'deliveryDetailsId_'.$orders->sku_id]) !!}
