    ...
    <div class="col-md-12">
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-balance-scale"></i>@lang('label.EDIT_PRODUCT_CONTAINER')
                </div>
            </div>
            <div class="portlet-body form">
                {!! Form::model($target, ['route' => ['productContainer.update', $target->id], 'method' => 'PATCH', 'class' => 'form-horizontal']) !!}
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-4 col-md-8">
                            ...
                            <a href="{{ URL::to('/admin/productContainer' . Helper::queryPageStr($qpArr)) }}"
