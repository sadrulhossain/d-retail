    ...
    <div class="col-md-12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-balance-scale"></i>@lang('label.PRODUCT_CONTAINER_LIST')
                </div>
                <div class="actions">
                    @if (!empty($userAccessArr[126][2]))
                        <a class="btn btn-default btn-sm create-new"
                            href="{{ URL::to('admin/productContainer/create' . Helper::queryPageStr($qpArr)) }}">
                            @lang('label.CREATE_NEW_PRODUCT_CONTAINER')
            ...
            <div class="portlet-body">
                <div class="row">
                    <!-- Begin Filter-->
                    {!! Form::open(['group' => 'form', 'url' => 'admin/productContainer/filter', 'class' => 'form-horizontal']) !!}
                    <div class="row">
                        <div class="col-md-4">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                                            ...
                                            <div class="width-inherit">
                                                @if (!empty($userAccessArr[9][3]))
                                                    <a class="btn btn-xs btn-primary tooltips" title="Edit"
                                                        href="{{ URL::to('admin/productContainer/' . $target->id . '/edit' . Helper::queryPageStr($qpArr)) }}">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                @endif
                                                @if (!empty($userAccessArr[9][4]))
                                                    {{ Form::open(['url' => 'admin/productContainer/' . $target->id . '/' . Helper::queryPageStr($qpArr),'class' => 'delete-form-inline']) }}
                            ...
                            @else
                                <tr>
                                    <td colspan="8">@lang('label.NO_PRODUCT_CONTAINER_FOUND')</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
