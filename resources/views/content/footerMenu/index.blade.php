...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-road"></i>@lang('label.FOOTER_MENU')
            </div>
            <div class="actions">
                @if(!empty($userAccessArr[117][2]))
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('admin/footerMenu/create'.Helper::queryPageStr($qpArr)) }}"> {{trans('Create New')}}
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td  class="text-center vcenter">
                                <div>
                                    {{ Form::open(array('url' => 'admin/footerMenu/' . $target->id, 'id'=>'delete')) }}
                                    {{ Form::hidden('_method', 'DELETE') }}
                                    @if(!empty($userAccessArr[117][3]))
                                    <a class="btn btn-icon-only btn-primary tooltips" title="Edit" href="{{ URL::to('admin/footerMenu/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    @endif
                                    @if(!empty($userAccessArr[117][4]))
