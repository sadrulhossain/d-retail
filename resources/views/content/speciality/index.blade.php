...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-home"></i>@lang('label.SPECIALITY')
            </div>
            <div class="actions">
                @if(!empty($userAccessArr[115][2]))
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('admin/speciality/create'.Helper::queryPageStr($qpArr)) }}"> {{trans('label.CREATE_NEW')}}
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td  class="text-center vcenter">
                                <div>
                                    {{ Form::open(array('url' => 'admin/speciality/' . $target->id, 'id'=>'delete')) }}
                                    {{ Form::hidden('_method', 'DELETE') }}
                                    @if(!empty($userAccessArr[115][3]))
                                    <a class="btn btn-icon-only btn-primary tooltips" title="Edit" href="{{ URL::to('admin/speciality/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    @endif
                                    @if(!empty($userAccessArr[115][4]))
