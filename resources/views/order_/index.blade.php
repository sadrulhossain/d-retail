...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            ...
            <div class="actions">
                @if(!empty($userAccessArr[102][2]) && Auth::user()->group_id == 14)
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('admin/order/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_ORDER')
        ...
        <div class="portlet-body">
            <!-- Begin Filter-->
            {!! Form::open(array('group' => 'form', 'url' => 'admin/order/filter','class' => 'form-horizontal')) !!}
