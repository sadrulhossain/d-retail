    ...
    <div class="col-md-12">
        <div class="portlet box green">
            ...
            <div class="portlet-body form">
                {!! Form::model($target, ['url' => '', 'method' => 'PATCH', 'id'=>'productCategoryForm', 'class' => 'form-horizontal', 'files' => true]) !!}
                {!! Form::hidden('filter', Helper::queryPageStr($qpArr)) !!}
                {!! Form::hidden('id', $target->id ?? 0) !!}
                {{ csrf_field() }}
                <div class="form-body">
                    <div class="row">
                        <div class="col-md-offset-1 col-md-8">
                            <div class="form-group">
                                <label class="control-label col-md-4" for="parentId">@lang('label.PARENT_CATEGORY')
                                    :</label>
                                <div class="col-md-8">
                                    {!! Form::select('parent_id', ['0' => __('label.SELECT_CATEGORY_OPT')] + $parentArr, null, ['class' => 'form-control js-source-states', 'id' => 'parentId']) !!}
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4" for="code">@lang('label.CODE') :<span
                                        class="text-danger"> *</span></label>
                                <div class="col-md-8">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4" for="fullDescription">@lang('label.DESCRIPTION')
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-4"
                                    for="highlighted">@lang('label.HIGHLIGHTED_FOR_HOME_PAGE') :</label>
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 150px; height: 120px;">
                                            @if (!empty($target->image))
                                                <img
                                                    src="{{ URL::to('/') }}/public/uploads/category/{{ $target->image }}" />
                                            @endif
                                        </div>
                                        ...
                                        <div>
                                            <span class="btn red btn-outline btn-file">
                                                ...
                                                {!! Form::file('image', null, ['id' => 'CategoryImage']) !!}
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-4 col-md-8">
                            ...
                            <a href="{{ URL::to('/admin/productCategory' . Helper::queryPageStr($qpArr)) }}"
        ...
        $(document).ready(function() {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    $.ajax({
                        url: "{{ URL::to('/admin/productCategory/update') }}",
                        type: "POST",
