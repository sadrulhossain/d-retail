    ...
    <div class="portlet box green">
        <div class="portlet-title">
            ...
            <div class="actions">
                ...
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('admin/contactDesignation/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_CONTACT_DESIGNATION')
        ...
        <div class="portlet-body">
            <div class="row">
                <!-- Begin Filter-->
                {!! Form::open(array('group' => 'form', 'url' => 'admin/contactDesignation/filter','class' => 'form-horizontal')) !!}
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <tr>
                            ...
                            <td class="td-actions text-center vcenter">
                                <div class="width-inherit">
                                    ...
                                    <a class="btn btn-xs btn-primary tooltips" title="Edit" href="{{ URL::to('admin/contactDesignation/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    @endif

                                    @if(!empty($userAccessArr[39][4]))
                                    {{ Form::open(array('url' => 'admin/contactDesignation/' . $target->id.'/'.Helper::queryPageStr($qpArr), 'class' => 'delete-form-inline')) }}
