                ...
                <div class="row">
                    <div class="col-md-offset-1 col-md-7">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                {!! Form::text('brand_code', null, ['id'=> 'brandCode', 'class' => 'form-control','autocomplete' => 'off']) !!} 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                @php
                                    $productList = explode(',',$target->manufactured_product);
                                @endphp
                                {!! Form::select('manufactured_product[]', $productArr, $productList, ['class' => 'form-control mt-multiselect btn btn-default', 
