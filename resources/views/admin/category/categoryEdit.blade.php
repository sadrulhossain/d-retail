...
<div class="content mt-3">
    ...
    <div class="card ml-5 mr-5">
        <div class="card-body card-block">
            <form action="{{ route('categoryUpdate',$category->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal">
                @csrf
                <div class="row form-group ml-5">
                    ...
                    <div class="col-12 col-md-6">
                        <input type="text" id="category_name" name="name" value="{{__($category->name)}}" class="form-control">
                    </div>
                </div>
                <div class="row form-group ml-5">
                    <div class="col col-md-2">
