                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                @if($i==1)
                                                <div class="col-md-3  contact-div">
                                                    {!! Form::text('contact_phone['.$identifier.']['.$key.']', $contact, ['id'=> 'contactPhone'.$identifier,'class' => ' focus-input']) !!} 
                                                ...
                                                @else
                                                <div class="col-md-3  contact-div">
                                                    {!! Form::text('contact_phone['.$identifier.']['.$v4.']',!empty($contactPerson['phone'])?$contactPerson['phone']:null, ['id'=> 'contactPhone'.$identifier,'class' => ' focus-input']) !!} 
                                                    <label class="floating-label" id="spanPhone_{{$identifier}}">@lang('label.PHONE') <span class="text-danger"> *</span></label>
                                                </div>
                                                <div class="col-md-1 margin-top-10">
                                                    <button class="btn btn-inline green-haze add-phone-number tooltips" data-key="{{$identifier}}" data-placement="right" title="@lang('label.ADD_NEW_PHONE_NUMBER')" type="button">
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-4 col-md-8">
                        <button class="btn btn-circle green" type="button" id="submitEditSupplier" >
        ...
        $(document).on("click", ".add-contact-person", function () {
            $.ajax({
                ...
                success: function (res) {
                    $("#newContactPerson").append(res.html);
                    $(".tooltips").tooltip();
                },
            });
        });
