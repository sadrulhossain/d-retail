<div class="modal-content">
    ...
    <div class="modal-body">
        ...
        <div class="row">
            <div class="col-md-4">
                <strong>@lang('label.ADJUSTMENT_DATE')</strong> : 
                {!! !empty($adjustmentInfo->adjustment_date) ? Helper::formatDate($adjustmentInfo->adjustment_date) : '' !!}
            </div>
            <div class="col-md-4">
                <strong>@lang('label.REFERENCE_NO')</strong> : {!! $adjustmentInfo->reference_no ?? '' !!}
            </div>
            <div class="col-md-4">
                <b>@lang('label.ADJUSTED_BY')</b> : {!! (!empty($adjustmentInfo->created_by) && !empty($userArr[$adjustmentInfo->created_by]))? $userArr[$adjustmentInfo->created_by] : '' !!}
            </div>
        </div>
        <div class="row margin-top-10">
            <div class="col-md-7">
                <b>@lang('label.ADJUSTED_AT')</b> : {!! !empty($adjustmentInfo->created_at) ? Helper::formatDateTime($adjustmentInfo->created_at) : '' !!}
            </div>
        </div>
                    ...
                    <table class="table table-bordered table-hover relation-view-2">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right vcenter">{!! Helper::numberFormatDigit2($item->quantity) !!}</td>
                            </tr>
                            @endforeach
                            @else
                            <tr>
