...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-list"></i>@lang('label.PRODUCT_ADJUSTMENT')
            </div>
            <div class="actions">
        ...
        <div class="portlet-body form">
            {!! Form::open(array('group' => 'form','class' => 'form-horizontal','id' => 'submit_form','files' => true)) !!}
            {!! Form::hidden('value', null, ["id"=>"avQuantityInput"]) !!}
                ...
                <div class="row">
                    ...
                    <div class="form">
                        <div class="col-md-3">
                            ...
                            {!! Form::text('adjustment_date_text',Helper::formatDate($adjustmentDate) , ['id'=> 'adjustmentDateText', 'class' => 'form-control', 'placeholder' => 'yyyy-mm-dd', 'readonly']) !!}
                            {!! Form::hidden('adjustment_date',$adjustmentDate , ['id'=> 'adjustmentDate', 'class' => 'form-control', 'placeholder' => 'yyyy-mm-dd', 'readonly']) !!}
                        </div>
                    </div>

                    <div class="form">
                        <div class="col-md-3">
                            <div class="fileinput fileinput-new width-full" data-provides="fileinput">
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <span class="btn green-seagreen btn-file">
                                        ...
                                        {!! Form::file('attachment', null,['id'=> 'attachmentFile']) !!}
                                    </span>
                                    <span class="fileinput-filename width-250"></span>&nbsp;
                                    <a href="javascript:;" class="close fileinput-exists" data-dismiss="fileinput"></a>
                                </div>
                                <div class="clearfix">
                                    <span class="label label-danger">@lang('label.NOTE')</span><br> @lang('label.ONLY_PDF_ALLOWED')
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="form-body">
                <div class="row">
                    <div class="col-md-12">
                        <p><b><u>@lang('label.ADJUSTED_ITEM_LIST'):</u></b></p>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(document).on("blur keyup", '#quantity', function () {
            var quantity = $(this).val();

            var avQuantity = $('#avQuantityInput').val();

           console.log($('#avQuantity').text());
            if (avQuantity == '') {
                swal({
        ...
        $(document).on("change", '#sku', function () {
            ...
            $.ajax({
                url: "{{URL::to('admin/productAdjustment/getProductName')}}",
                type: 'POST',
                dataType: 'json',
                headers: {
                ...
                success: function (res) {
                    ...
                    $('#avQuantityInput').val(res.quantity);
...
//            }
            ...
            $.ajax({
                url: "{{ URL::to('admin/productAdjustment/purchaseNew')}}",
                type: "POST",
                dataType: 'json',
                cache: false,
                headers: {
    ...
    $(document).on("click", ".button-submit", function (e) {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    url: "{{URL::to('admin/productAdjustment/adjustProduct')}}",
                    type: "POST",
                    ...
                    success: function (res) {
                        toastr.success('Product Adjusted Successfully', 'Success', options);
                        setTimeout(() => {
                            window.location.replace("{{URL::to('admin/productAdjustment')}}");
                        }, 2000);
                    },
                    error: function (jqXhr, ajaxOptions, thrownError) {
