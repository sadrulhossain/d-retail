...
//                        ->where('product_checkin_master.ref_no', $request->ref_no)
        ...
        $targetArr = ProductCheckInDetails::where('master_id', $target['id'])
                        ...
                        ->select('product.name as product_name', 'brand.name as brand_name', 'product_category.name as category_name'
                                , 'supplier.name as supplier_name', 'supplier.address as saddress', 'product_checkin_details.quantity'
                                , 'product_checkin_details.rate', 'product_unit.name as unit_name'
                                , 'product_sku_code.sku')->get();
