...
class DesignationController extends Controller {
    ...
    public function index(Request $request) {
        ...
        $nameArr = Designation::select('title')->get();
        ...
        if ($targetArr->isEmpty() && isset($qpArr['page']) &&  ($qpArr['page'] > 1)) {
            $page = ($qpArr['page'] - 1);
            return redirect('/admin/designation?page=' . $page);
        }
    ...
    public function store(Request $request) {
        ...
        if ($validator->fails()) {
            return redirect('admin/designation/create' . $pageNumber)
                            ->withInput()
    ...
    public function update(Request $request, $id) { //print_r($request->all());exit;
        ...
        if ($validator->fails()) {
            return redirect('admin/designation/' . $id . '/edit' . $pageNumber)
                            ->withInput()
                            ->withErrors($validator);
        }
        ...
        if ($target->save()) {
            ...
            return redirect('admin/designation' . $pageNumber);
        } else {
